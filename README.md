...
[![Twitter Follow](https://img.shields.io/twitter/follow/codewithsadee_?style=social)](https://twitter.com/intent/follow?screen_name=codewithsadee_)
  ...
  <a href="https://charles-portfolio-eta.vercel.app/"><strong>➥ Live Demo</strong></a>
...
![Pfolio Desktop Demo](./readme-images/ss.png "Desktop Demo")
...
```bash
sudo git clone https://github.com/4urie/CharlesPortfolio.git
```

Windows:

```bash
git clone https://github.com/4urie/CharlesPortfolio.git
```
